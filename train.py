...
def get_args():
    ...
    parser.add_argument('--layer_sizes', type=int, nargs='+', default=[512, 256, 128, 64, 128, 256, 512])
...
if __name__ == '__main__':
    ...
    if args.continue_from is not None:
        agent_1 = RawPolicyAgent.load(f'checkpoints/{args.continue_from}/epoch_{args.start_epoch}.msh')
    else:
        agent_1 = build_agent(
            mdp.env_info,
    ...
    if args.continue_from is None:
        ...
        logger = Logger(args.continue_from, results_dir='./logs', log_console=True, append=True)
    ...
    for epoch in range(args.start_epoch, args.end_epoch):
        ...
        core.learn(n_steps=args.n_steps, n_steps_per_fit=1)
